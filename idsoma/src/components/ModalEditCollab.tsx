...
import styles from "../styles/components/ModalEditCollab.module.css";

interface ModalEditCollabProps {
  isOpen: boolean;
  onClose: () => void;
  onSave: (data: { name: string; cpf: string; role: string }) => void;
}

const ModalEditCollab: React.FC<ModalEditCollabProps> = ({
  isOpen,
  onClose,
  onSave,
}) => {
  ...
  return (
    <div className={styles.modalOverlay}>
      <div className={styles.modalContent}>
        <h2 className={styles.modalTitle}>Editar Colaborador</h2>
...
export default ModalEditCollab;
